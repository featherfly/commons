 ...
 * @author zhongj
 */
public class EmployeeAccessorSwitchDirect implements PropertyAccessor<Employee> {

    public static final EmployeeAccessorSwitchDirect INSTANCE = new EmployeeAccessorSwitchDirect();
    ...
    private EmployeeAccessorSwitchDirect() {
