...
public class RandomUtilsTest {
    ...
    public void testStringLowerCase() {
        ...
        for (int i = 0; i < 10; i++) {
            String result = RandomUtils.getRandomString(i + 5, new CharType[] { CharType.LOWER_CASE });
    ...
    public void testStringUpperCase() {
        ...
        for (int i = 0; i < 10; i++) {
            String result = RandomUtils.getRandomString(i + 5, new CharType[] { CharType.UPPER_CASE });
            System.out.println(result);
        }
    }
    ...
    public void testStringNumberCase() {
        ...
        for (int i = 0; i < 10; i++) {
            String result = RandomUtils.getRandomString(i + 5, new CharType[] { CharType.NUMBER_CASE });
            System.out.println(result);
        }
    }
