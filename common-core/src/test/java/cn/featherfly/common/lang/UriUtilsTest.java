...
public class UriUtilsTest {
    ...
    @Test
    void link() {
        assertEquals(UriUtils.linkUri("aa", "bb", "cc"), "aa/bb/cc");
    ...
    public void appendParam() {
        ...
        result = UriUtils.appendParam(result, "id", 1);
        System.out.println(result);
        assertEquals(result, "www.baidu.com?id=1");

        result = UriUtils.appendParam(result, "name", "yufei");
        System.out.println(result);
    ...
    public void appendParamMulitiValues() {
        ...
        String result = url;
        result = UriUtils.appendParam(result, "name", Lang.array("yufei", "yi"));
        System.out.println(result);
        assertEquals(result, "www.baidu.com?name=yufei&name=yi");
        result = UriUtils.appendParam(result, "id", (ArrayList<Integer>) Lang.list(18, 20));
        System.out.println(result);
    ...
    public void appendParamMapMulitiValues() {
        ...
        result = UriUtils.appendParam(url, params);
        System.out.println(result);
        ...
        result = UriUtils.appendParam(url, params2);
        ...
        result = UriUtils.appendParam(result, params3);
