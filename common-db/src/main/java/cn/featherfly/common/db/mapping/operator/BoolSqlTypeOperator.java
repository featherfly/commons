...
/**
 * The Class BoolTypeSqlTypeOperator.
 *
 * @author zhongj
 */
public class BoolSqlTypeOperator implements JavaTypeSqlTypeOperator<Boolean> {

    /**
     * Instantiates a new bool type sql type operator.
     */
    public BoolSqlTypeOperator() {
