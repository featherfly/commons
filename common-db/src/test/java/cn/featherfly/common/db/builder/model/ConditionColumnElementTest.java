...
public class ConditionColumnElementTest {
    ...
    void mysql() {
        ...
        c = new ConditionColumnElement(dialect, userTableAlias, "username", "yufei", ComparisonOperator.EQ,
        ...
        c = new ConditionColumnElement(dialect, "u", "age", age, ComparisonOperator.LT, IgnoreStrategy.EMPTY);
        print(c);
        ...
        c = new ConditionColumnElement(dialect, "u", "age", age, ComparisonOperator.LE, IgnoreStrategy.EMPTY);
        print(c);
        assertEquals(c.toSql(), "u.`age` <= ?");
        assertEquals(c.getParam(), age);
        ...
        assertEquals(c.toSql(), "`age` >= ?");
        assertEquals(c.getParam(), age);
        c = new ConditionColumnElement(dialect, "u", "age", age, ComparisonOperator.GE, IgnoreStrategy.EMPTY);
        print(c);
        assertEquals(c.toSql(), "u.`age` >= ?");
        assertEquals(c.getParam(), age);
        ...
        assertEquals(c.toSql(), "`age` > ?");
        assertEquals(c.getParam(), age);
        c = new ConditionColumnElement(dialect, "u", "age", age, ComparisonOperator.GT, IgnoreStrategy.EMPTY);
        print(c);
        assertEquals(c.toSql(), "u.`age` > ?");
        assertEquals(c.getParam(), age);
        ...
        assertEquals(c.toSql(), "`age` != ?");
        assertEquals(c.getParam(), age);
        c = new ConditionColumnElement(dialect, "u", "age", age, ComparisonOperator.NE, IgnoreStrategy.EMPTY);
        print(c);
        assertEquals(c.toSql(), "u.`age` != ?");
        assertEquals(c.getParam(), age);
        ...
        c = new ConditionColumnElement(dialect, "u", "name", name, ComparisonOperator.CO, IgnoreStrategy.EMPTY);
        print(c);
        ...
        assertEquals(c.getParam(), "%" + name + "%");
        c = new ConditionColumnElement(dialect, "u", "name", name, ComparisonOperator.NCO, IgnoreStrategy.EMPTY);
        print(c);
        ...
        assertEquals(c.toSql(), "`name` LIKE ?");
        assertEquals(c.getParam(), name + "%");
        c = new ConditionColumnElement(dialect, "u", "name", name, ComparisonOperator.SW, IgnoreStrategy.EMPTY);
        print(c);
        assertEquals(c.toSql(), "u.`name` LIKE ?");
        assertEquals(c.getParam(), name + "%");
        ...
        assertEquals(c.toSql(), "`name` NOT LIKE ?");
        assertEquals(c.getParam(), name + "%");
        c = new ConditionColumnElement(dialect, "u", "name", name, ComparisonOperator.NSW, IgnoreStrategy.EMPTY);
        print(c);
        assertEquals(c.toSql(), "u.`name` NOT LIKE ?");
        assertEquals(c.getParam(), name + "%");
        ...
        assertEquals(c.toSql(), "`name` LIKE ?");
        assertEquals(c.getParam(), "%" + name);
        c = new ConditionColumnElement(dialect, "u", "name", name, ComparisonOperator.EW, IgnoreStrategy.EMPTY);
        print(c);
        assertEquals(c.toSql(), "u.`name` LIKE ?");
        assertEquals(c.getParam(), "%" + name);
        ...
        assertEquals(c.toSql(), "`name` NOT LIKE ?");
        assertEquals(c.getParam(), "%" + name);
        c = new ConditionColumnElement(dialect, "u", "name", name, ComparisonOperator.NEW, IgnoreStrategy.EMPTY);
        print(c);
        assertEquals(c.toSql(), "u.`name` NOT LIKE ?");
        assertEquals(c.getParam(), "%" + name);
        ...
        assertEquals(c.getParam(), ParamType.NONE);
        c = new ConditionColumnElement(dialect, "u", "mobile", value, ComparisonOperator.ISN, IgnoreStrategy.EMPTY);
        print(c);
        ...
        //        assertEquals(c.getParam(), ParamType.NONE);
        assertEquals(c.getParam(), ParamType.NONE);
        c = new ConditionColumnElement(dialect, "u", "mobile", value, ComparisonOperator.INN, IgnoreStrategy.EMPTY);
        print(c);
        ...
        c = new ConditionColumnElement(dialect, "u", "tag", ArrayUtils.toList(tags), ComparisonOperator.IN,
            IgnoreStrategy.EMPTY);
        print(c);
        ...
        assertEquals(((List<Object>) c.getParam()).toArray(), tags);
        c = new ConditionColumnElement(dialect, "u", "tag", ArrayUtils.toList(tags), ComparisonOperator.NI,
            IgnoreStrategy.EMPTY);
        print(c);
        ...
        assertEquals(c.toSql(), "`name` LIKE ?");
        assertEquals(c.getParam(), name);
        c = new ConditionColumnElement(dialect, "u", "name", name, ComparisonOperator.LK, IgnoreStrategy.EMPTY);
        print(c);
        assertEquals(c.toSql(), "u.`name` LIKE ?");
        assertEquals(c.getParam(), name);
        ...
        assertEquals(c.toSql(), "`name` NOT LIKE ?");
        assertEquals(c.getParam(), name);
        c = new ConditionColumnElement(dialect, "u", "name", name, ComparisonOperator.NL, IgnoreStrategy.EMPTY);
        print(c);
        assertEquals(c.toSql(), "u.`name` NOT LIKE ?");
        assertEquals(c.getParam(), name);
        ...
        c = new ConditionColumnElement(dialect, "u", "age", name, ComparisonOperator.BA, IgnoreStrategy.EMPTY);
        print(c);
        ...
        c = new ConditionColumnElement(dialect, "u", "age", name, ComparisonOperator.NBA, IgnoreStrategy.EMPTY);
        print(c);
    ...
    void mysql_sqlelement() {
        Dialect dialect = Dialects.mysql();
        SqlElement se = new ColumnElement(dialect, userTableAlias2, usernameColumn);
        c = new ConditionColumnElement(dialect, userTableAlias, usernameColumn, se, ComparisonOperator.EQ,
            IgnoreStrategy.EMPTY);
        print(c);
    ...
    void postgresql() {
        ...
        c = new ConditionColumnElement(dialect, "u", "username", "yufei", ComparisonOperator.EQ, IgnoreStrategy.EMPTY);
        assertEquals(c.toSql(), "u.\"username\" = ?");
        assertEquals(c.getParam(), username);
        print(c);
    ...
    void oracle() {
        ...
        print(c);
        assertEquals(c.toSql(), "'mobile' IS NULL");
        assertEquals(c.getParam(), Params.ParamType.NONE);
        c = new ConditionColumnElement(dialect, "u", "mobile", value, ComparisonOperator.ISN, IgnoreStrategy.EMPTY);
        print(c);
        assertEquals(c.toSql(), "u.'mobile' IS NULL");
        assertEquals(c.getParam(), ParamType.NONE);
