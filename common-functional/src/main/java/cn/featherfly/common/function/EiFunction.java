 ...
 */
@FunctionalInterface
public interface EiFunction<E1, E2, E3, E4, E5, E6, E7, E8, R> {
     ...
     */
    R apply(E1 e1, E2 e2, E3 e3, E4 e4, E5 e5, E6 e6, E7 e7, E8 e8);
     ...
     */
    default <V> EiFunction<E1, E2, E3, E4, E5, E6, E7, E8, V> andThen(Function<? super R, ? extends V> after) {
        Objects.requireNonNull(after);
        return (E1 e1, E2 e2, E3 e3, E4 e4, E5 e5, E6 e6, E7 e7, E8 e8) -> after
            .apply(apply(e1, e2, e3, e4, e5, e6, e7, e8));
    }
}
