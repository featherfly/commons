 ...
 */
@FunctionalInterface
public interface FiConsumer<E1, E2, E3, E4, E5> {
     ...
     */
    default FiConsumer<E1, E2, E3, E4, E5> andThen(
        FiConsumer<? super E1, ? super E2, ? super E3, ? super E4, ? super E5> after) {
        Objects.requireNonNull(after);
        return (e1, e2, e3, e4, e5) -> {
            accept(e1, e2, e3, e4, e5);
            after.accept(e1, e2, e3, e4, e5);
        };
    }
}
