 ...
 */
@FunctionalInterface
public interface FiPredicate<E1, E2, E3, E4, E5> {
     ...
     */
    boolean test(E1 e1, E2 e2, E3 e3, E4 e4, E5 e5);
     ...
     */
    default FiPredicate<E1, E2, E3, E4, E5> and(
        FiPredicate<? super E1, ? super E2, ? super E3, ? super E4, ? super E5> other) {
        Objects.requireNonNull(other);
        return (E1 e1, E2 e2, E3 e3, E4 e4, E5 e5) -> test(e1, e2, e3, e4, e5) && other.test(e1, e2, e3, e4, e5);
    }
     ...
     *         predicate
     */
    default FiPredicate<E1, E2, E3, E4, E5> negate() {
        return (E1 e1, E2 e2, E3 e3, E4 e4, E5 e5) -> !test(e1, e2, e3, e4, e5);
    }
     ...
     * @throws NullPointerException if other is null
     */
    default FiPredicate<E1, E2, E3, E4, E5> or(
        FiPredicate<? super E1, ? super E2, ? super E3, ? super E4, ? super E5> other) {
        Objects.requireNonNull(other);
        return (E1 e1, E2 e2, E3 e3, E4 e4, E5 e5) -> test(e1, e2, e3, e4, e5) || other.test(e1, e2, e3, e4, e5);
    }
