 ...
 */
@FunctionalInterface
public interface FourArgusConsumer<E1, E2, E3, E4> {
     ...
     */
    default FourArgusConsumer<E1, E2, E3, E4> andThen(
            FourArgusConsumer<? super E1, ? super E2, ? super E3, ? super E4> after) {
