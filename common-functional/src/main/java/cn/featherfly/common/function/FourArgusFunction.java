 ...
 */
@FunctionalInterface
public interface FourArgusFunction<E1, E2, E3, E4, R> {
     ...
     */
    R apply(E1 e1, E2 e2, E3 e3, E4 e4);
     ...
     */
    default <V> FourArgusFunction<E1, E2, E3, E4, V> andThen(Function<? super R, ? extends V> after) {
        Objects.requireNonNull(after);
        return (E1 e1, E2 e2, E3 e3, E4 e4) -> after.apply(apply(e1, e2, e3, e4));
    }
}
