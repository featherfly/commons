 ...
 */
@FunctionalInterface
public interface SePredicate<E1, E2, E3, E4, E5, E6, E7> {
     ...
     */
    boolean test(E1 e1, E2 e2, E3 e3, E4 e4, E5 e5, E6 e6, E7 e7);
     ...
     */
    default SePredicate<E1, E2, E3, E4, E5, E6, E7> and(
        SePredicate<? super E1, ? super E2, ? super E3, ? super E4, ? super E5, ? super E6, ? super E7> other) {
        Objects.requireNonNull(other);
        return (E1 e1, E2 e2, E3 e3, E4 e4, E5 e5, E6 e6, E7 e7) -> test(e1, e2, e3, e4, e5, e6, e7)
            && other.test(e1, e2, e3, e4, e5, e6, e7);
    }
     ...
     *         predicate
     */
    default SePredicate<E1, E2, E3, E4, E5, E6, E7> negate() {
        return (E1 e1, E2 e2, E3 e3, E4 e4, E5 e5, E6 e6, E7 e7) -> !test(e1, e2, e3, e4, e5, e6, e7);
    }
     ...
     * @throws NullPointerException if other is null
     */
    default SePredicate<E1, E2, E3, E4, E5, E6, E7> or(
        SePredicate<? super E1, ? super E2, ? super E3, ? super E4, ? super E5, ? super E6, ? super E7> other) {
        Objects.requireNonNull(other);
        return (E1 e1, E2 e2, E3 e3, E4 e4, E5 e5, E6 e6, E7 e7) -> test(e1, e2, e3, e4, e5, e6, e7)
            || other.test(e1, e2, e3, e4, e5, e6, e7);
