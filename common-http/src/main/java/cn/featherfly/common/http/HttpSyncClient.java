 ...
 * @author zhongj
 */
public class HttpSyncClient extends AbstractHttpClient
        implements HttpClient<String>, HttpDownloadClient<Integer>, HttpStreamClient<InputStream> {
     ...
     */
    public HttpSyncClient(HttpRequestConfig config, Map<String, String> headers, Serialization serialization,
            MediaType mediaType) {
     ...
     * @param headers the headers
     */
    public HttpSyncClient(HttpRequestConfig config, Map<String, String> headers) {
     ...
     * @param mediaType     the media type
     */
    public HttpSyncClient(HttpRequestConfig config, Serialization serialization, MediaType mediaType) {
     ...
     * @param config the config
     */
    public HttpSyncClient(HttpRequestConfig config) {
        super(config);
    }
     ...
     * @param headers the headers
     */
    public HttpSyncClient(Map<String, String> headers) {
        super(headers);
    }
     ...
     * @param mediaType     the media type
     */
    public HttpSyncClient(OkHttpClient client, Map<String, String> headers, Serialization serialization,
            MediaType mediaType) {
     ...
     * @param headers the headers
     */
    public HttpSyncClient(OkHttpClient client, Map<String, String> headers) {
     ...
     * @param mediaType     the media type
     */
    public HttpSyncClient(OkHttpClient client, Serialization serialization, MediaType mediaType) {
