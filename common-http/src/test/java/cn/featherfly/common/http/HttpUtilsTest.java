...
import cn.featherfly.common.structure.LinkedHashChainMap;
...
public class HttpUtilsTest {
    ...
    public void testAppendParams() {
        ...
        ChainMap<String, Serializable> params = new LinkedHashChainMap<String, Serializable>().putChain("id", 1)
                .putChain("name", "yufei");
        ...
        ChainMap<String, Serializable> params2 = new LinkedHashChainMap<String, Serializable>().putChain("age", 18);
