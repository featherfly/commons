...
public class SerializationExceptionCode extends cn.featherfly.common.exception.SimpleLocalizedExceptionCode {
    ...
    public enum SerializationExceptionCodes {
         ...
         * @param num num
         */
        SerializationExceptionCodes(String key, Integer num) {
            this.key = key;
            this.num = num;
        }
     ...
     */
    public static SerializationExceptionCode createSerializeErrorCode(java.lang.String className,
            java.lang.String errorMessage) {
        return new SerializationExceptionCode(SerializationExceptionCodes.EASYSOCKET10001.num,
                SerializationExceptionCodes.EASYSOCKET10001.key, new Object[] { className, errorMessage });
    }
     ...
     */
    public static SerializationExceptionCode createDeserializeErrorCode(java.lang.String className,
            java.lang.String errorMessage) {
        return new SerializationExceptionCode(SerializationExceptionCodes.EASYSOCKET10002.num,
                SerializationExceptionCodes.EASYSOCKET10002.key, new Object[] { className, errorMessage });
    }
     ...
     */
    public static SerializationExceptionCode createNoSerializerForMimeTypeCode(java.lang.String mimeType) {
        return new SerializationExceptionCode(SerializationExceptionCodes.EASYSOCKET10003.num,
                SerializationExceptionCodes.EASYSOCKET10003.key, new Object[] { mimeType });
    }
