...
/**
 * An implementation class of a {@link MutableTuple10}.
 * <p>
 ...
 * @author Per Minborg
 */
public final class MutableTuple10Impl<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> 
extends AbstractMutableTuple 
implements MutableTuple10<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> {
    
    /**
     * Constructs a {@link MutableTuple} of type {@link MutableTuple10}.
     */
    public MutableTuple10Impl() {
        super(MutableTuple10Impl.class, 10);
    }
