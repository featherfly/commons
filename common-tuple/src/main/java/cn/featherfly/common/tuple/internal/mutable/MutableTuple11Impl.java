...
/**
 * An implementation class of a {@link MutableTuple11}.
 * <p>
 ...
 * @author Per Minborg
 */
public final class MutableTuple11Impl<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> 
extends AbstractMutableTuple 
implements MutableTuple11<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> {
    
    /**
     * Constructs a {@link MutableTuple} of type {@link MutableTuple11}.
     */
    public MutableTuple11Impl() {
        super(MutableTuple11Impl.class, 11);
    }
