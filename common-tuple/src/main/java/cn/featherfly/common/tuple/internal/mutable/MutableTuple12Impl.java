...
/**
 * An implementation class of a {@link MutableTuple12}.
 * <p>
 ...
 * @author Per Minborg
 */
public final class MutableTuple12Impl<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> 
extends AbstractMutableTuple 
implements MutableTuple12<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> {
    
    /**
     * Constructs a {@link MutableTuple} of type {@link MutableTuple12}.
     */
    public MutableTuple12Impl() {
        super(MutableTuple12Impl.class, 12);
    }
