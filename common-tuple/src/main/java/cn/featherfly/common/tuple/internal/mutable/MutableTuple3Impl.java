...
/**
 * An implementation class of a {@link MutableTuple3}.
 * <p>
 ...
 * @author Per Minborg
 */
public final class MutableTuple3Impl<T0, T1, T2> 
extends AbstractMutableTuple 
implements MutableTuple3<T0, T1, T2> {
    
    /**
     * Constructs a {@link MutableTuple} of type {@link MutableTuple3}.
     */
    public MutableTuple3Impl() {
        super(MutableTuple3Impl.class, 3);
    }
