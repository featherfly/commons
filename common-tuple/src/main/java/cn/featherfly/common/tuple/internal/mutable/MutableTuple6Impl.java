...
/**
 * An implementation class of a {@link MutableTuple6}.
 * <p>
 ...
 * @author Per Minborg
 */
public final class MutableTuple6Impl<T0, T1, T2, T3, T4, T5> 
extends AbstractMutableTuple 
implements MutableTuple6<T0, T1, T2, T3, T4, T5> {
    
    /**
     * Constructs a {@link MutableTuple} of type {@link MutableTuple6}.
     */
    public MutableTuple6Impl() {
        super(MutableTuple6Impl.class, 6);
    }
