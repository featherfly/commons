...
/**
 * An implementation class of a {@link MutableTuple8}.
 * <p>
 ...
 * @author Per Minborg
 */
public final class MutableTuple8Impl<T0, T1, T2, T3, T4, T5, T6, T7> 
extends AbstractMutableTuple 
implements MutableTuple8<T0, T1, T2, T3, T4, T5, T6, T7> {
    
    /**
     * Constructs a {@link MutableTuple} of type {@link MutableTuple8}.
     */
    public MutableTuple8Impl() {
        super(MutableTuple8Impl.class, 8);
    }
