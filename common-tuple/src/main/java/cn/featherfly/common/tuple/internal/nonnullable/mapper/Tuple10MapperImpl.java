...
extends AbstractTupleMapper<T, Tuple10<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>> 
implements TupleMapper<T, Tuple10<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>> {
    ...
    @Override
    public Tuple10<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> apply(T t) {
        return Tuples.of(
            get0().apply(t),
            get1().apply(t),
            get2().apply(t),
