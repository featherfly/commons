...
extends AbstractTupleMapper<T, Tuple7<T0, T1, T2, T3, T4, T5, T6>> 
implements TupleMapper<T, Tuple7<T0, T1, T2, T3, T4, T5, T6>> {
    ...
    @Override
    public Tuple7<T0, T1, T2, T3, T4, T5, T6> apply(T t) {
        return Tuples.of(
            get0().apply(t),
            get1().apply(t),
            get2().apply(t),
