...
/**
 * An implementation class of a {@link Tuple5OfNullables}.
 * <p>
 ...
 * @author Per Minborg
 */
public final class Tuple5OfNullablesImpl<T0, T1, T2, T3, T4> 
extends AbstractTupleOfNullables 
implements Tuple5OfNullables<T0, T1, T2, T3, T4> {
    
    /**
     * Constructs a {@link TupleOfNullables} of type {@link Tuple5OfNullables}.
     * 
     * @param e0 element 0
     * @param e1 element 1
     * @param e2 element 2
     ...
     * @param e4 element 4
     */
    public Tuple5OfNullablesImpl(
            T0 e0,
            T1 e1,
            T2 e2,
            T3 e3,
            T4 e4) {
        super(Tuple5OfNullablesImpl.class, e0, e1, e2, e3, e4);
    }
