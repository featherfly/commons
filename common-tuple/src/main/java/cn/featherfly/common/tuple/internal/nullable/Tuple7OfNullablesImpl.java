...
/**
 * An implementation class of a {@link Tuple7OfNullables}.
 * <p>
 ...
 * @author Per Minborg
 */
public final class Tuple7OfNullablesImpl<T0, T1, T2, T3, T4, T5, T6> 
extends AbstractTupleOfNullables 
implements Tuple7OfNullables<T0, T1, T2, T3, T4, T5, T6> {
    
    /**
     * Constructs a {@link TupleOfNullables} of type {@link Tuple7OfNullables}.
     * 
     * @param e0 element 0
     * @param e1 element 1
     * @param e2 element 2
    ...
    public Tuple7OfNullablesImpl(
            ...
            T5 e5,
            T6 e6) {
        super(Tuple7OfNullablesImpl.class, e0, e1, e2, e3, e4, e5, e6);
    }
