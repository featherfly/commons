...
/**
 * An implementation class of a {@link Tuple8OfNullables}.
 * <p>
 ...
 * @author Per Minborg
 */
public final class Tuple8OfNullablesImpl<T0, T1, T2, T3, T4, T5, T6, T7> 
extends AbstractTupleOfNullables 
implements Tuple8OfNullables<T0, T1, T2, T3, T4, T5, T6, T7> {
    
    /**
     * Constructs a {@link TupleOfNullables} of type {@link Tuple8OfNullables}.
     * 
     * @param e0 element 0
     * @param e1 element 1
     * @param e2 element 2
    ...
    public Tuple8OfNullablesImpl(
            ...
            T6 e6,
            T7 e7) {
        super(Tuple8OfNullablesImpl.class, e0, e1, e2, e3, e4, e5, e6, e7);
    }
