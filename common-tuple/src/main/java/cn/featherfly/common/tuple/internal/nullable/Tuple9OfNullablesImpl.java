...
/**
 * An implementation class of a {@link Tuple9OfNullables}.
 * <p>
 ...
 * @author Per Minborg
 */
public final class Tuple9OfNullablesImpl<T0, T1, T2, T3, T4, T5, T6, T7, T8> 
extends AbstractTupleOfNullables 
implements Tuple9OfNullables<T0, T1, T2, T3, T4, T5, T6, T7, T8> {
    
    /**
     * Constructs a {@link TupleOfNullables} of type {@link Tuple9OfNullables}.
     * 
     * @param e0 element 0
     * @param e1 element 1
     * @param e2 element 2
    ...
    public Tuple9OfNullablesImpl(
            ...
            T7 e7,
            T8 e8) {
        super(Tuple9OfNullablesImpl.class, e0, e1, e2, e3, e4, e5, e6, e7, e8);
    }
