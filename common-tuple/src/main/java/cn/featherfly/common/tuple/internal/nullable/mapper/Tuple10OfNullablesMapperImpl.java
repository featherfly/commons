...
import cn.featherfly.common.tuple.Tuple10;
 ...
 * @author Per Minborg
 */
public final class Tuple10OfNullablesMapperImpl<T, T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> 
extends AbstractTupleMapper<T, Tuple10OfNullables<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>> 
implements TupleMapper<T, Tuple10OfNullables<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>> {
    
    /**
     * Constructs a {@link TupleMapper } that can create {@link Tuple10 }.
     * 
     ...
     */
    public Tuple10OfNullablesMapperImpl(
            Function<T, T0> m0,
            Function<T, T1> m1,
            Function<T, T2> m2,
            Function<T, T3> m3,
    ...
    @Override
    public Tuple10OfNullables<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> apply(T t) {
