...
import cn.featherfly.common.tuple.Tuple11;
 ...
 * @author Per Minborg
 */
public final class Tuple11OfNullablesMapperImpl<T, T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> 
extends AbstractTupleMapper<T, Tuple11OfNullables<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> 
implements TupleMapper<T, Tuple11OfNullables<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> {
     ...
     */
    public Tuple11OfNullablesMapperImpl(
            Function<T, T0> m0,
            Function<T, T1> m1,
            Function<T, T2> m2,
            Function<T, T3> m3,
    ...
    @Override
    public Tuple11OfNullables<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> apply(T t) {
