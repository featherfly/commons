...
import cn.featherfly.common.tuple.Tuple12;
 ...
 * @author Per Minborg
 */
public final class Tuple12OfNullablesMapperImpl<T, T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> 
extends AbstractTupleMapper<T, Tuple12OfNullables<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>> 
implements TupleMapper<T, Tuple12OfNullables<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>> {
     ...
     */
    public Tuple12OfNullablesMapperImpl(
            Function<T, T0> m0,
            Function<T, T1> m1,
            Function<T, T2> m2,
            Function<T, T3> m3,
    ...
    @Override
    public Tuple12OfNullables<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> apply(T t) {
