 ...
 * @author Per Minborg
 */
public final class Tuple6OfNullablesMapperImpl<T, T0, T1, T2, T3, T4, T5> 
extends AbstractTupleMapper<T, Tuple6OfNullables<T0, T1, T2, T3, T4, T5>> 
implements TupleMapper<T, Tuple6OfNullables<T0, T1, T2, T3, T4, T5>> {
     ...
     */
    public Tuple6OfNullablesMapperImpl(
            Function<T, T0> m0,
            Function<T, T1> m1,
            Function<T, T2> m2,
            Function<T, T3> m3,
    ...
    @Override
    public Tuple6OfNullables<T0, T1, T2, T3, T4, T5> apply(T t) {
