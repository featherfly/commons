 ...
 * @author Per Minborg
 */
public final class Tuple7OfNullablesMapperImpl<T, T0, T1, T2, T3, T4, T5, T6> 
extends AbstractTupleMapper<T, Tuple7OfNullables<T0, T1, T2, T3, T4, T5, T6>> 
implements TupleMapper<T, Tuple7OfNullables<T0, T1, T2, T3, T4, T5, T6>> {
