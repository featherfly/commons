 ...
 * @author Per Minborg
 */
public final class Tuple8OfNullablesMapperImpl<T, T0, T1, T2, T3, T4, T5, T6, T7> 
extends AbstractTupleMapper<T, Tuple8OfNullables<T0, T1, T2, T3, T4, T5, T6, T7>> 
implements TupleMapper<T, Tuple8OfNullables<T0, T1, T2, T3, T4, T5, T6, T7>> {
     ...
     */
    public Tuple8OfNullablesMapperImpl(
            Function<T, T0> m0,
            Function<T, T1> m1,
            Function<T, T2> m2,
            Function<T, T3> m3,
    ...
    @Override
    public Tuple8OfNullables<T0, T1, T2, T3, T4, T5, T6, T7> apply(T t) {
