...
//	}
    ...
    private <T> BeanProperty<T> create(Class<?> ownerType, String name, Field field, Class<T> propertyType, Method setMethod, Method getMethod, Class<?> declaringType) {
		...
		try {
			...
			String propertyClassName = ownerType.getPackage() + "._" + ownerType.getSimpleName()
			...
			return (BeanProperty<T>) Class.forName(propertyClassName)
					.getConstructor(String.class, Field.class, Class.class, Method.class, Method.class
