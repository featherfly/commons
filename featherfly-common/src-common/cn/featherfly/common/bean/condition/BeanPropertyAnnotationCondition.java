 ...
 * @author 钟冀
 */
public class BeanPropertyAnnotationCondition implements BeanPropertyCondition{
	 ...
	 */
	public BeanPropertyAnnotationCondition(Class<?>...annotationClasses) {
	 ...
	 * @param annotationClasses 注解类型
	 */
	public BeanPropertyAnnotationCondition(Logic logic, Class<?>...annotationClasses) {
