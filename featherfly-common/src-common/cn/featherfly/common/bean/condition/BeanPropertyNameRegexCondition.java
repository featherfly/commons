 ...
 * @author 钟冀
 */
public class BeanPropertyNameRegexCondition implements BeanPropertyCondition{

	private static final Logger LOGGER = LoggerFactory
			.getLogger(BeanPropertyNameRegexCondition.class);
	 ...
	 */
	public BeanPropertyNameRegexCondition(String nameRegex) {
	 ...
	 * @param flags 正则模式 
	 */
	public BeanPropertyNameRegexCondition(String nameRegex, int flags) {
