...
/**
 * <p>
 * 断言工具类，对于满足断言的情况，抛出StandardAppException异常
 * 一般用于检查传入参数是否合法
 * </p>
 *
 * @author 钟冀
 ...
 * @version 1.0
 */
public final class AssertStandardApp {

    private static final Assert ASSERT = new Assert(StandardAppException.class);

    private AssertStandardApp() {
    }

    /**
     * <p>
     * 判断不为空，如果为空，抛出StandardAppException异常
     * </p>
     * @param object 判断的对象
    ...
    /**
     * <p>
     * 判断为true，如果为false，抛出StandardAppException异常
     * </p>
    ...
    /**
     * <p>
     * 判断为false，如果为true，抛出StandardAppException异常
     * </p>
     * @param expression 判断的值
     * @param message 断言失败的信息
     * @传入的参数
    ...
    /**
     * <p>
     * 判断不为空或空串（包括只有空字符的串），判断失败抛出StandardAppException异常
     * </p>
     * @param text 判断的字符串
     * @param message 断言失败的信息
     * @传入的参数
    ...
    /**
     * <p>
     * 判断不为空（String,Collection,Map,Array还要判断长度是否为0），判断失败抛出StandardAppException异常
     * </p>
     * @param obj 判断的对象
     * @param message 断言失败的信息
     * @传入的参数
    ...
    /**
     * <p>
     * 判断不为空或空串，判断失败抛出StandardAppException异常
     * </p>
     * @param text 判断的字符串
     * @param message 断言失败的信息
     * @传入的参数
    ...
    /**
     * <p>
     * 判断数组不为null或size不为0，判断失败抛出StandardAppException异常
     * </p>
     * @param array 需要判断的数组
     * @param message 断言失败的信息
     * @传入的参数
    ...
    /**
     * <p>
     * 判断集合不为null或size不为0，判断失败抛出StandardAppException异常
     * </p>
    ...
    /**
     * <p>
     * 判断MAP不为null或size不为0，判断失败抛出StandardAppException异常
     * </p>
     * @param map 判断的集合
     * @param message 断言失败的信息
     * @传入的参数
    ...
    /**
     * <p>
     * 判断传入文件对象代表的物理文件是否存在，判断失败抛出StandardAppException异常
     * </p>
     * @param file 判断的文件对象
     * @param message 断言失败的信息
     * @传入的参数
    ...
    /**
     * <p>
     * 判断对象（第二个参数）是指定类型（第一个参数）的实例，判断失败抛出StandardAppException异常
     * </p>
     * @param clazz 类型
     * @param obj 对象
     * @param message 断言失败的信息
