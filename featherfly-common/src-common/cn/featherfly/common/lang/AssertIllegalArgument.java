...
public final class AssertIllegalArgument {
	...
	private static final Assert a = new Assert(IllegalArgumentException.class);
	...
	/**
	 * <p>
	 * 判断为true，如果为false，抛出IllegalArgumentException异常
	 * </p>
	...
	/**
	 * <p>
	 * 判断为false，如果为true，抛出IllegalArgumentException异常
	 * </p>
	 * @param expression 判断的值
	 * @param message 断言失败的信息
	 * @return 传入的参数
	...
	/**
	 * <p>
	 * 判断对象（第二个参数）是指定类型（第一个参数）的实例，判断失败抛出IllegalArgumentException异常
	 * </p>
	 * @param clazz 类型
	 * @param obj 对象
	 * @param message 断言失败的信息
