...
public final class AssertUtils {
	 ...
	 * @param message 断言失败的信息
	 */
	public static <E extends RuntimeException> void isFalse(boolean expression, String message, Class<E> exceptionType) {
	 ...
	 * @param message 断言失败的信息
	 */
	public static <E extends RuntimeException> void isNotEmpty(Collection<?> collection, String message, Class<E> exceptionType) {
	 ...
	 * @param message 断言失败的信息
	 */
	public static <E extends RuntimeException> void isInstanceOf(Class<?> clazz, Object obj, String message, Class<E> exceptionType) {
