...
public class StringUtilsTest {
    ...
    public void testChineseNumber1() {
        ...
        for (int i = 0; i < 10; i++) {
            String s = StringUtils.toChineseNumber(i, simple);
    ...
    public void testChineseNumber2() {
        ...
        intNum = 10;
        s = StringUtils.toChineseNumber(intNum, simple);
    ...
    public void testChineseNumber7Simple() {
        ...
        s = StringUtils.toChineseNumber(longNum, simple);
        System.out.println(intNum + "\t" + s);
    ...
    public void testChineseMoneyNumber() {
        s = StringUtils.toChineseMoneyNumber(12d);
        System.out.println(intNum + "\t" + s);
        assertEquals(s, "壹拾贰圆整");

        s = StringUtils.toChineseMoneyNumber(12.3);
        System.out.println(intNum + "\t" + s);
        assertEquals(s, "壹拾贰圆叁角整");
        s = StringUtils.toChineseMoneyNumber(12.34);
        System.out.println(intNum + "\t" + s);
        assertEquals(s, "壹拾贰圆叁角肆分整");

        s = StringUtils.toChineseMoneyNumber(12.04);
        System.out.println(intNum + "\t" + s);
